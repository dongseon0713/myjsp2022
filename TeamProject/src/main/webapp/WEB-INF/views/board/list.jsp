...
<section id="contentwrap">
            <div id="content_bottom" class="top_padding">
              ...
              <c:choose>
              <c:when test="${city eq 'metropolitanCity'}">
			...
			<table id="table">
                ...
                <ul>
				<c:if test="${ page.prev }">
					<li><a href="list?city=${ city }&pageNum=${ page.startPage - 1 }">Previous</a></li>
				</c:if>
				<c:forEach var="num" begin="${ page.startPage }"
					end="${ page.endPage }">
					<li>
						<a href="list?city=${ city }&pageNum=${ num }">${ num }</a>
					</li>
				</c:forEach>
				<c:if test="${ page.next }">
					<li><a href="list?city=${ city }&pageNum=${ page.endPage + 1 }">Next</a></li>
				</c:if>
			</ul>
