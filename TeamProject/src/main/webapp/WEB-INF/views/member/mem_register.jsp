            ...
            <form action="joinForm" id="joinForm" method="post">
                ...
                <table id="regist_table" width="40%" style="text-align: left; font-size: 12px; background-color: ">
                   <tr>
                       ...
                       <td colspan="2"><input type="text" name="id" id="id" style="border: none; background-color: #ffffff; height: 40px; width: 100%">
						<td>
                       ...
                       <td  colspan="3"><input type="password" name="pw" id="pw" style="border: none; background-color: #ffffff; height: 40px; width: 100%">
                    </tr>
                    
                     <tr>
                       <td style="width:30%;  height:50px" >비밀번호 확인</td>
                       <td  colspan="3"><input type="password" name="pwCheck"  id="pwCheck"style="border: none; background-color: #ffffff; height: 40px; width: 100%">
                    </tr>
                    
                     <tr>
                       <td style="width:30%;  height:50px" >이름</td>
                       <td  colspan="3"><input type="text" name="name"  id="name"style="border: none; background-color: #ffffff; height: 40px; width: 100%">
                    </tr>
                    <tr>
                   		<td style="width:30%;  height:50px" >전화번호</td>
                   		<td>
                   			<select name="phone">
                        ...
                        <td><input type="text" name="phone1"  id="phone1" style="border: none; background-color: #ffffff; height: 20px; width: 100%"></td>
                        <td><input type="text" name="phone2"  id="phone2" style="border: none; background-color: #ffffff; height: 20px; width: 100%"></td>
                    </tr>
                      <tr>
                       <td style="width:30%;  height:50px" >닉네임</td>
                       <td  colspan="2"><input type="text" name="nickname"  id="nickname"style="border: none; background-color: #ffffff; height: 40px; width: 100%">
                       <td>
                    ...
                    <tr>
                       ...
                       <td  colspan="3"><input type="text" name="address" id="address" style="border: none; background-color: #ffffff; height: 40px; width: 100%">
                    </tr>
                    <tr>
                       <td style="width:30%;  height:50px"> 이메일</td>
                       <td  colspan="3"><input type="email" name="email" id="email"style="border: none; background-color: #ffffff; height: 40px; width: 100%">
                    </tr>
                    <tr>
                ...
                <div class="btn_area double">
                	...
                	<span>
                		<input type="button" class="btn_type btn_primary" value="확인" onclick="joinCheck()">
                	</span>
                </div>
            </form>
...
<script src="${pageContext.request.contextPath}/resources/vendor/jquery/jquery.min.js"></script>
	...
	<script type="text/javascript">
   		function IdCheck(){
   			...
   			var user_id = {"id" : id};	//전송할 데이터의 key값
   		...
   		function NickCheck(){
   			...
   			var user_Nick = {"nickname" : nickname};	//전송할 데이터의 key값
