...
<body>
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="/SpringWeb/board/list">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="/SpringWeb/board/register">
          <i class="fas fa-fw fa-table"></i>
          <span>공지사항 등록</span></a>
      </li>
            ...
            <c:otherwise>
	            <li class="nav-item dropdown no-arrow">
	              <a class="nav-link dropdown-toggle" href="/member/login" >
	                <span class="mr-2 d-none d-lg-inline text-gray-600 small">로그인 하세요.</span>
	                <img class="img-profile rounded-circle" src="/resources/img/user.png">
	              </a>	
	            </li>
            </c:otherwise>
